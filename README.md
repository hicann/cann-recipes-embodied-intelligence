...
| [Pi0.5](manipulation/pi05/train/README.md) | Atlas A2 | torch | 在Atlas A2环境进行Pi0.5模型的训练，精度正常，性能达到较优的水平。 | **88.89 samples/s** (优化后) |
| [ACT](manipulation/act/train/README.md) | Atlas A2 | torch | 在Atlas A2环境进行 ACT 模型训练，支持 8 卡分布式训练与评测。 | **760.24 samples/s** (优化后) |

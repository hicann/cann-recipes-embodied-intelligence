...
SMOLVLA_PATCH_PATH="$SCRIPT_DIR/../patches/lerobot_smolvla_ascend.patch"
LEROBOT_COMMIT="58f70b6bd370864139a3795ac3497a9eae8c42d5"  # 2025-11-27

CREATE_CONDA=false
ENV_NAME="lerobot-smolvla"
PYTHON_VERSION="3.10"
TORCH_WHEEL=""
TORCHVISION_WHEEL=""
TORCH_NPU_WHEEL=""
...
Prepare the SmolVLA training workspace on Ascend.
...
Notes:
  ...
  2. The script installs LeRobot common dependencies, LIBERO dependencies and SmolVLA dependencies.
...
=============================================
SmolVLA training workspace is ready.
LeRobot root: $LEROBOT_ROOT
LeRobot commit: $LEROBOT_COMMIT
Common patch: $COMMON_PATCH_PATH
SmolVLA patch: $SMOLVLA_PATCH_PATH

Recommended next steps:
  1. Prepare ../dataset/HuggingFaceVLA/libero
  2. Prepare ../models/lerobot/smolvla_base
  3. Prepare ../models/HuggingFaceTB/SmolVLM2-500M-Video-Instruct
  4. Run smoke:
